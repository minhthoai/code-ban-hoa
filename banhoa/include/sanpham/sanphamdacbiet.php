<?php 
	$strSQL="SELECT * FROM hoa WHERE trang_thai=1 ORDER BY ma_hoa desc";
	$hoadacbiet=mysql_query($strSQL,$ung);
?>
			...
			<td>
				...
				<table width="220" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td>
						<?php $i=0;
						while($rowHDB=mysql_fetch_array($hoadacbiet)) 
						{ 
								$i+=1; 
								//xu ly mau cho dong
									if($i%2==0) 
							...
							<div style="border:1px #CCCCCC solid; margin-top:4px; width:220px; height:62px;">
								<table width="220" height="52" cellpadding="0" cellspacing="0" border="0" style="margin-top:4px; margin-bottom:4px;">
									<tr>
										...
										&nbsp;&nbsp;
										<a href="#" onclick="chitiet('<?php echo $rowHDB['ma_hoa']; ?>')"><b><?php echo $rowHDB['ten_hoa']; ?></b>
										</a>
										<br />
										&nbsp;&nbsp;<span class="demuc">Giá Bán:</span><?php echo number_format($rowHDB['gia'],0,'.','.'); ?> đ
										</td>
										<td width="70" align="center">
										<a href="#" onclick="chitiet('<?php echo $rowHDB['ma_hoa']; ?>')">
