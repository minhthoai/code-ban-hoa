...
{	
	...
	//Lay mahd 
	$mahd=mysql_insert_id($ung);

	//luu thong tin hoa don chi tiet
	for($i=0; $i<$n; $i++)
	{
	$strSQL="INSERT INTO ct_dondathang (ma_dh,ma_hoa,gia_ban,sl_dat) VALUES({$mahd},{$arrmasp[$i]},{$arrdongia[$i]},{$arrsoluong[$i]})";
	mysql_query($strSQL,$ung);
	}
