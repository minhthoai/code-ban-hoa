...
<script language="JavaScript" type="text/javascript">
	function kiemtra()
	{
		...
		if(dien=="")
		{
			document.all('loidienthoai').innerHTML="Bạn Chưa Nhập Số Điện Thoại !"
		...
		{	
			if(lt==false)
			{
				document.all('loidienthoai').innerHTML="Bạn Phải Nhập Bằng Số Và Có Từ 10 Đến 11 Chữ Số!"
				frm.txtsdt.style.backgroundColor='#FFFFCC'
				frm.txtsdt.focus()
				return false
			}
		...
		if(cm=="")
		{
			document.all('loithoai').innerHTML="Bạn Chưa Gửi Yêu Cầu !"
			frm.txtthoai.style.backgroundColor="#FFFFCC"
			frm.txtthoai.focus()
			return false
		}
		else
		{	
			...
			document.all('loithoai').innerHTML=""
			frm.txtthoai.style.backgroundColor="#FFFFFF"
		}
    ...
    <table cellpadding="4" cellspacing="0" border="0" align="center" width="450">
      <tr>
		...
		<tr>
        	...
        	<td width="330"><input name="txtten" type="text" id="txtten" size="40" value="<?php echo $_SESSION['tenkhach']; ?>" />
      ...
      <tr>
        	<td>Số Điện Thoại</td>
       		 <td><input name="txtsdt" type="text" id="txtsdt" size="40" value="<?php echo $_SESSION['sdtkhach']; ?>" />
      				  &nbsp;&nbsp;<font color="#FF6600">*</font><br />
			<span id="loidienthoai" style="color:#FF6600;"></span>		
			</td>
      </tr>
      <tr>
        	<td align="left">Email</td>
       		 <td><input name="txtemail" type="text" id="txtemail" size="40" value="<?php echo $_SESSION['emailkhach']; ?>" />
      			  &nbsp;&nbsp;<font color="#FF6600">*</font><br />
      ...
      <tr>
	   ...
	   <tr>
        	<td>Địa Chỉ</td>
       		 <td><textarea name="txtdc" cols="43" rows="2" id="txtdc" style="border-right:none;" ><?php echo $_SESSION['diachikhach']; ?></textarea>
      ...
      <tr>
        	<td align="left">Nội Dung</td>
       		 <td><textarea name="txtthoai" cols="43" rows="5" id="txtthoai" style="border-right:none;"><?php echo $_SESSION['noidung']; ?></textarea>
       		 &nbsp;&nbsp;<font color="#FF6600">*</font><br />
				<span id="loithoai" style="color:#FF6600;"></span>		
			</td>
      </tr>
	   <tr>
          <td align="center">
