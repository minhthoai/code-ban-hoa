...
function them_admin()
{
	...
	if(isset($_POST['hoadmin']))
		$hoadmin=$_POST['hoadmin'];
	...
	//neu thoa man tiep tuc
	$strSQL="INSERT INTO adm(ten_dn,mat_khau,ho,ten,gioi_tinh) VALUES('{$tendangnhap}','{$matkhau}','{$hoadmin}','{$tenadmin}','{$gioitinh}')";
	mysql_query($strSQL);
...
function sua_admin()
{
	...
	$strSQL="UPDATE adm SET mat_khau='{$matkhau}',ho='{$hoadmin}',ten='{$tenadmin}',gioi_tinh='{$gioitinh}' WHERE ma_adm={$maadmin}";
	mysql_query($strSQL,$ung);
