...
<table width="750" cellpadding="2" cellspacing="0" border="0" class="admintable" style="border-right:#E9E9E9 1px solid; border-top:#E9E9E9 1px solid;" align="right">
	...
	<tr>
		...
		<tr>
			...
			<td width="180" align="center">Tên Hoa</td>
		...
		<tr>
			...
			<td align="center">
				<?php
					//lay ten hoa thong qua ma hoa
					$strSQL4="SELECT * FROM hoa WHERE ma_hoa={$rowCT['ma_hoa']}";
					$hoa=mysql_query($strSQL4,$ung);
					$row4=mysql_fetch_array($hoa);
